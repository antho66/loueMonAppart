		...
		<header>
			<div class="wrapper">
				...
				<nav>
					...
					<a href="login" class="login_btn">Se connecter </a>
				</nav>
			</div>
	...
	<section class="listings">
		<div class="wrapper">
			...
			<?php foreach($annonces as $annonce){ ?>
				<li>
					<a href="louer">
						<img src="images/<?php if(count($annonce->getPhotos())>0) echo $annonce->getPhotos()[0]->getUrl(); ?>" alt="" title="" class="property_img"/>
					</a>
				...
				<!-- <li>
					...
					<div class="property_details">
						<h1>
							<a href="#">Saltem id perquisitor malivolus pro .</a>
						</h1>
						<h2>Interfecti eodem sorte plumbi senatores sunt firmarat plumbi hoe assim venenorum nominare. <span class="property_size">(288ftsq)</span></h2>
					</div>
				</li>
				<li>
					<a href="#">
				...
				<li>
					...
					<div class="property_details">
						<h1>
							<a href="#">Que quam ego tot necessitatem.</a>
						</h1>
				...
				<li>
					...
					<div class="property_details">
						...
						<h2>Miretur repentelongos ductante repente.<span class="property_size">(288ftsq)</span></h2>
					</div>
				</li>
				<li>
					<a href="#">
				...
				<li>
					...
					<div class="property_details">
						<h1>
							<a href="#">Membrorum peremptae velemen quidem .</a>
						</h1>
						<h2>Gravius circenses inter haec liquido  multavit. <span class="property_size">(288ftsq)</span></h2>
					</div>
				</li>
				<li>
					<a href="#">
				...
				<li>
					...
					<div class="property_details">
						...
						<h2>Philosophus dignitatem orator ab et dipesceret ab ducitur.<span class="property_size">(288ftsq)</span></h2>
					</div>
				</li> -->
			</ul>
